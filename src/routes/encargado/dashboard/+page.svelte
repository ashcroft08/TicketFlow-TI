        ...
        <header class="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-6 mb-12">
            ...
            <div class="flex items-center gap-3">
                ...
                <form action="/?/logout" method="POST">
                    <button type="submit" class="h-12 w-12 bg-white/70 dark:bg-slate-800/60 backdrop-blur-xl border border-slate-200 dark:border-slate-700/60 text-slate-500 hover:text-error dark:text-slate-400 dark:hover:text-red-400 hover:bg-error/10 dark:hover:bg-red-500/10 rounded-xl flex items-center justify-center transition-all duration-200 hover:shadow-sm" title="Cerrar Sesión">
