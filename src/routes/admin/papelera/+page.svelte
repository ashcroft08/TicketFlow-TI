    ...
    <div class="flex flex-wrap gap-2">
        {#each tabs as tab}
            <button
                ...
                class="flex items-center gap-2 px-4 py-2 rounded-lg text-xs font-bold uppercase tracking-tight transition-all {activeTab === tab.id ? 'bg-primary text-white shadow-lg shadow-primary/25' : 'glass-card text-text-dim dark:text-dark-text-dim hover:text-primary'}"
            >
        ...
        {#if activeTab === 'users'}
            {#if filteredUsers.length === 0}
                <div class="p-16 text-center">
                    <PackageOpen class="w-12 h-12 text-text-dim/30 mx-auto mb-4" />
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-primary/5 border-b border-white/5">
                                ...
                                <th class="px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim">Rol</th>
                                <th class="px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim">Sucursal</th>
                                <th class="px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim">Eliminado el</th>
                                <th class="px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim text-right">Acción</th>
                            </tr>
                        </thead>
                                ...
                                <tr class="group hover:bg-primary/5 transition-colors" transition:fade>
                                    ...
                                    <td class="px-5 py-3 text-right">
                                        <form use:enhance={() => {
                                            ...
                                            <button type="submit" class="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-success/10 text-success hover:bg-success/20 border border-success/20 transition-all text-[10px] font-bold uppercase tracking-widest">
            ...
            {:else}
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-primary/5 border-b border-white/5">
                                <th class="px-6 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim">Nombre de Sede</th>
                                <th class="px-6 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim">Eliminada el</th>
                                <th class="px-6 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim text-right">Acción</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-white/5">
            ...
            {:else}
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-primary/5 border-b border-white/5">
                                <th class="px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim">Equipo</th>
                                <th class="px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim">Identificación</th>
                                <th class="px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim">Ubicación</th>
                                <th class="px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim">Eliminado el</th>
                                <th class="px-5 py-3 text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim text-right">Acción</th>
                            </tr>
                        </thead>
