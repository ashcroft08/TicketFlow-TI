    ...
    <header class="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
            <div class="flex items-center gap-2 mb-1">
                ...
                <span class="text-[10px] font-bold uppercase tracking-widest text-text-dim dark:text-dark-text-dim">Cuenta Maestra</span>
            </div>
            <h1 class="text-2xl font-bold text-text-main dark:text-dark-text-main tracking-tight">Mi Perfil</h1>
            <p class="text-xs text-text-dim dark:text-dark-text-dim font-medium">Gestión de identidad y parámetros de seguridad.</p>
        </div>
    </header>
